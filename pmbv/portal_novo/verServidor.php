...
if (isset($_GET['lotacao']) and ($_GET['lotacao'] != ''))
{
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (Secretaria LIKE '%".$bSecretaria."%') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$bMes.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$bAno.") AND (Nome LIKE '%".$bNome."%') OR (CPF LIKE '%".$bNome."%') ORDER BY Nome ASC");
...
//calcula o número de páginas
        ...
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (Secretaria LIKE '%".$bSecretaria."%') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$bMes.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$bAno.") AND (Nome LIKE '%".$bNome."%') OR (CPF LIKE '%".$bNome."%') ORDER BY Nome ASC limit $inicio,$registros");
        $servidor = mysql_query($rs_servidor);
        $total = mysql_num_rows($servidor);
    }else{
        $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;

        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (Secretaria LIKE '%".$bSecretaria."%') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$meshoje.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$anohoje.") ORDER BY Nome ASC");
        $servidor = mysql_query($rs_servidor);
...
//calcula o número de páginas
        ...
        $inicio = ($registros*$pagina)-$registros;
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (Secretaria LIKE '%".$bSecretaria."%') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$meshoje.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$anohoje.") ORDER BY Nome ASC limit $inicio,$registros");
        $servidor = mysql_query($rs_servidor);
        $total = mysql_num_rows($servidor);
    }
...
}elseif (isset($_GET['cargo']) and ($_GET['cargo'] != ''))
{
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$bMes.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$bAno.") AND (Cargo LIKE '%".$bCargo."%') AND (Nome LIKE '%".$bNome."%') OR (CPF LIKE '%".$bNome."%') ORDER BY Nome ASC");
        $servidor = mysql_query($rs_servidor);
...
//calcula o número de páginas
        ...
        $inicio = ($registros*$pagina)-$registros;
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$bMes.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$bAno.") AND (Cargo LIKE '%".$bCargo."%') AND (Nome LIKE '%".$bNome."%') OR (CPF LIKE '%".$bNome."%') ORDER BY Nome ASC limit $inicio,$registros");
        $servidor = mysql_query($rs_servidor);
        $total = mysql_num_rows($servidor);
    }else{
        $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;

        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (Cargo LIKE '%".$bCargo."%') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$meshoje.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$anohoje.") ORDER BY Nome ASC");
        $servidor = mysql_query($rs_servidor);
...
//calcula o número de páginas
        ...
        $inicio = ($registros*$pagina)-$registros;
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (Cargo LIKE '%".$bCargo."%') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$meshoje.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$anohoje.") ORDER BY Nome ASC limit $inicio,$registros");
        $servidor = mysql_query($rs_servidor);
        $total = mysql_num_rows($servidor);
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$bMes.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$bAno.") AND (Nome LIKE '%".$bNome."%') OR (CPF LIKE '%".$bNome."%') ORDER BY Nome ASC");
        $servidor = mysql_query($rs_servidor);
...
//calcula o número de páginas
        ...
        $inicio = ($registros*$pagina)-$registros;
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$bMes.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$bAno.") AND (Nome LIKE '%".$bNome."%') OR (CPF LIKE '%".$bNome."%') ORDER BY Nome ASC limit $inicio,$registros");
        $servidor = mysql_query($rs_servidor);
        $total = mysql_num_rows($servidor);
    }else{
        $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;

        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$meshoje.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$anohoje.") ORDER BY Nome ASC");
        $servidor = mysql_query($rs_servidor);
...
//calcula o número de páginas
        ...
        $inicio = ($registros*$pagina)-$registros;
        $rs_servidor = ("SELECT * FROM servidor WHERE (Disponivel = 'sim') AND (DATE_FORMAT(DtDisponivel, '%c') = ".$meshoje.") AND (DATE_FORMAT(DtDisponivel, '%Y') = ".$anohoje.") ORDER BY Nome ASC limit $inicio,$registros");
        $servidor = mysql_query($rs_servidor);
        $total = mysql_num_rows($servidor);
    }
}
