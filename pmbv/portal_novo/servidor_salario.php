...
$sqlLinha5 = mysql_query("SELECT * FROM servidor WHERE Acao = 'Publicado' AND CdServidor = '".$CdServidor."' ORDER BY Ano DESC, Mes DESC");
                ...
                <?php if ($conta != '0'){ ?>
                    <div class="profile-header clearfix text-left">
                        ...
                        <div id="anos" class="col-md-12">
                            <div class="text-right col-md-2">
                                <div class="btn-group">
                                    <button type="button" id="dashboardRange" class="btn btn-3d btn-black pull-right dropdown-toggle" data-toggle="dropdown">
                                        <span><?php echo $rsLinha2['Ano'];?></span>
                            ...
                            <div class="col-md-10">
                            <?php
                            $sqll = "SELECT * FROM servidor WHERE CPF = '".$rsLinha2['CPF']."' AND Ano = ".$rsLinha2['Ano']." AND (Acao = 'Publicado') ORDER BY Ano DESC, Mes DESC";

                            $sqlEstrutura = mysql_query($sqll) or die(mysql_error());
                            ...
                            if ($linha['DecimoFinal'] != '0.00'){
                                ...
                                if ($linha['CdServidor'] == $CdServidor){
                                    $classSel = "btn btn-success";
                                }else{
                                    $classSel = "btn btn-primary";
                                }

                            ?>
                            <a class="<?php echo $classSel;?>" type="button" onclick="salario(<?php echo $linha['CdServidor'];?>)"><?php echo retorna_mes_extenso($linha['Mes']);?> <?php echo $decimo1 ?></a>
                            <?php } ?>
                        ...
                        <section id="visualizar" class="texto-simples">
                            ...
                            <?php
                            if ($rsLinha5['DecimoFinal'] == '0.00'){
                                $decimo3 = "";
                            }else{
                                $decimo3 = "2º parcela 13º";
                            }

                            if ($rsLinha5['DecimoAdto'] == '0.00'){
                                $decimo3 = "";
                            }else{
                                $decimo3 = " - 1º parcela 13º";
                            }
                            ?>
                            <div class="container">
                                <div class="col-xs-12 col-sm-12 col-md-12 pull-left">
                                    <h2 class="title title-d">
                                        ...
                                        <strong><?php echo $rsLinha5['Ano'];?></strong> <small> <?php echo $decimo3 ?></small>
                                    </h2>
                                </div>

                                <?php if ($rsLinha5['DecimoFinal'] != '0.00'){

                                    $deciF = $rsLinha5['DecimoFinal'];
                                    $RemF = $rsLinha5['RemuneracaoBasica'];

                                    $DecimoUltimo = $RemF-$deciF;

                                    $Remuneracao =  number_format($DecimoUltimo, 2, ',', '.');
                                    $texto = "Remuneração 13º";

                                 }else{
                                    $texto = "Remuneração básica bruta";
                                     $Remuneracao =  number_format($rsLinha5['RemuneracaoBasica'], 2, ',', '.');
                                 } ?>
                                ...
                                <div class="mar-40 col-xs-9 col-sm-9 col-md-9">
                                    <table class="table table-afiliados" summary="Despesas com pessoal">
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-sm-4">
                                                <small><?php echo $Remuneracao;?></small>
                                            </td>
                                        </tr>
                                        </tbody>
                                        <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-sm-4">
                                                <small class="texto-vermelho"> -
                                                    <?php
                                                    if ($rsLinha5['IRRF'] != "0.00"){
                                                        echo number_format($rsLinha5['IRRF'], 2, ',', '.');
                                                    }else {
                                                        echo number_format($rsLinha5['DecimoIRRF'], 2, ',', '.');
                                                    }
                                                    ?></small>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="col-sm-4">
                                                <small class="texto-vermelho"> -
                                                    <?php
                                                    if ($rsLinha5['INSS'] != "0.00"){
                                                        echo number_format($rsLinha5['INSS'], 2, ',', '.');
                                                    }else {
                                                        echo number_format($rsLinha5['DecimoINSS'], 2, ',', '.');
                                                    }
                                                    ?>
                                                    </small>
                                            </td>
