<script>
    ...
    function carregaMesAno(mes,ano){
        $('#loading2').css('visibility','visible');
        $.post("diarias_mes_ano.php", { mes: mes, ano: ano },
            function(data){
                $('#resultado').html(data);
            }).done(function() {
                $('#loading2').css('visibility','hidden');
                ...
                if ($Conta != 0) {
                    ...
                    <div id="anos" class="col-md-12 text-left">
                        ...
                        <div class="col-md-11 text-left">
                            ...
                            $sql = "SELECT * FROM diarias WHERE ano = " . $AnoSeleciona . " AND Acao = 'Publicado' GROUP BY mes ORDER BY ano DESC, mes DESC";
                            ...
                            for ($y = 0; $y < $Glossario; $y++) {
                                ...
                                <a onclick="carregaMesAno(<?php echo $verGlossario['mes']; ?>,<?php echo $verGlossario['ano']; ?>)" href="javascript:void(0)">
                                    <i class="btn btn-3d btn-dirtygreen"><?php echo retorna_mes_extenso($verGlossario['mes']); ?> / <?php echo $verGlossario['ano']; ?></i>
                                </a>
                            <?php
                            }
                            ?>
                    ...
                    <div id="verDados" class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body text-center">
                                <h4>
                                    DIÁRIAS DE <?php echo retorna_mes_extenso($MesSelecionado); ?> / <?php echo $AnoSeleciona; ?>
                                    <br>
                                ...
                                <?php
                                $sql = "SELECT * FROM diarias WHERE Acao = 'Publicado' AND mes = ".$MesSelecionado." AND ano = ".$AnoSeleciona." ORDER BY Acao ASC";
                                $sqlGlossario = mysql_query($sql);
                                $Glossario = mysql_num_rows($sqlGlossario);
