...
<?php
$sqlUlt = mysql_query("SELECT * FROM cpl WHERE Acao = 'Aprovado' GROUP BY ano, mes ORDER BY ano DESC, mes DESC LIMIT 1");
...
<div id="corpo_servidor">
    <table class="table table-hover">
        ...
        $sql = "SELECT * FROM cpl WHERE (Acao = 'Aprovado') AND ( ano = ".$rsLinha2['ano'].") AND ( mes = ".$rsLinha2['mes'].")";
        ...
        for ($y = 0; $y < $Glossario; $y++){
            ...
            <tr class='clickable-row' onclick="seleciona(<?php echo $verGlossario['id'];?>)">
