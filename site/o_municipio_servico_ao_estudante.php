  ...
  <div class="container">
    <header>
      <ul class="breadcrumb dontPrint">
        ...
        <li class="active">Serviço ao Estudante</li>
      </ul>
      <h1> Serviço ao Estudante</h1>
    </header>
  </div>
</section>
      ...
      <div class="col-md-9 col-sm-9" role="main">
        <div class="col-md-12 mb10">
          <ul class="nav nav-list mt10">
            <?php
            $sqlGlossario = mysql_query("SELECT * FROM vw_servicos WHERE  tipo = 'estudante' AND CdPrefeitura = '".$rsPrefeitura['CdPrefeitura']."' AND Acao = 'Publicado' ORDER BY Titulo ASC");
