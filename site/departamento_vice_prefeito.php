<section class="page-title">
  <?php
  $sqlPagina = mysql_query("SELECT * FROM gabinete WHERE CdPrefeitura = '".$rsPrefeitura['CdPrefeitura']."' AND Tipo = 'Vice'");
  ...
  <div class="container">
    <header>
      <ul class="breadcrumb dontPrint">
        ...
        <li class="active">Gabinete do Vice - Prefeito(a)</li>
      </ul>
      <h1>Gabinete do Vice - Prefeito(a)</h1>
    </header>
  </div>
</section>
