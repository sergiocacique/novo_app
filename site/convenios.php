<script>
    ...
    function carregaMesAno(mes,ano,prefeitura){
        $('#loading2').css('visibility','visible');
        $.post("<?php echo $UrlAmigavel;?>convenios_mes_ano.php", { mes: mes, ano: ano, prefeitura: prefeitura },
            function(data){
                $('#resultado').html(data);
                $('html, body').animate({scrollTop:0}, 'slow');
            }).done(function() {
...
<section class="texto-simples">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 pull-left">
        <h2 class="title title-d"> <strong>CONVÊNIOS</strong></h2>
    </div>
...
<section class="texto-simples mar-top-30">
    <div id="resultado">
<?php
$sqlDespesa = mysql_query("SELECT * FROM convenios WHERE CdPrefeitura = '".$rsPrefeitura['CdPrefeitura']."' AND Acao = 'Publicado' GROUP BY ano ORDER BY ano DESC, mes DESC LIMIT 1");
...
?>
    <div class="container">
        <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 pull-left">
                <h2 class="title title-d"> <strong></strong> <?php echo $rsDespe['ano']; ?></h2>
            </div>
                ...
                <div id="atualiza" class="pull-right hidden-xs">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php
                            $sqlAnos = mysql_query("SELECT * FROM convenios WHERE (CdPrefeitura = ".$rsPrefeitura['CdPrefeitura'].") GROUP BY ano, mes ORDER BY ano DESC, mes DESC ");
    ...
    <table class="table table-afiliados" summary="Passagens">
        ...
        $sqlGlossario = mysql_query("SELECT * FROM convenios WHERE CdPrefeitura = '".$rsPrefeitura['CdPrefeitura']."' AND Acao = 'Publicado' AND ( ano = ".$rsDespe['ano'].")");
