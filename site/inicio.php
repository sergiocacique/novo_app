    ...
    <div class="row nomargin">
        ...
        <div class="col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div id="owl-carousel" class="owl-carousel" data-plugin-options='{"singleItem": false, "items":"4", "autoPlay": 4000, "navigation": true, "pagination": false}'>
                    <?php
                    $sqlEstrutura1 = mysql_query("SELECT *  FROM site_noticias WHERE CdPrefeitura = '".$rsPrefeitura['CdPrefeitura']."' AND Acao = 'Publicado' AND Destaque = 'nao' ORDER BY DtCadastro DESC LIMIT 3") or die(mysql_error());
...
<section class="parallax parallax-2" style="background-image: url('https://www.minhaprefeitura.com.br/arquivosDinamicos/municipio/<?php echo $rsPrefeitura['Pasta'] ?>/20-min.jpg');">
