                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-8 col-sm-8 col-md-8 pull-left">
                            <h2 class="title title-d"> <strong>Receitas Extra-Orçamentária </strong></h2>
                        </div>
<br>
                            ...
                            <div id="atualiza" class="pull-right hidden-xs">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <?php
                                        $sqlAnos = mysql_query("SELECT * FROM receitas WHERE Categoria = 'extra' AND (CdPrefeitura = ".$CdPrefeitura.") GROUP BY Ano ORDER BY Ano DESC");
...
<section id="ver" class="texto-simples container">
    <div class="row">
        <?php
        $sqlLeis = mysql_query("SELECT * FROM receitas WHERE receitas = 'extra' AND CdPrefeitura = '".$CdPrefeitura."' AND Ano = '" .$ano. "' ORDER BY Mes ASC");
