...
$ID = addslashes($_POST['id']);
    ...
    if ($_FILES['arquivo']['name'] != "") {
        ...
        $dir = '../arquivosDinamicos/municipio/'.$verAdmin['Pasta'].'/departamento/';
        ...
        if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $dir . $nome_final)) {
            ...
            $query = $query . " Profissao = '" . $Profissao . "'";
            $query = $query . " WHERE";
            $query = $query . " id = '" . $ID . "'";
...
header('Location: departamento_vice_prefeito.php'); exit;
?>
