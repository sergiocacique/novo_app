...
$DtCadastro = date('Y-m-d H:i:s');
    ...
    if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $dir . $nome_final)) {
        ...
        $query = "INSERT INTO cpl_anexo (CdPrefeitura,CdUsuario,CdCPL,Arquivo,Tipo,Acao,DtCadastro) VALUES ('" . $CdPrefeitura . "','" . $CdUsuario . "','" . $CdCPL . "','" . $nome_final . "','" . $Tipo . "','" . $Acao . "','" . $DtCadastro . "')";
