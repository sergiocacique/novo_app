...
$sqlPagina = mysql_query("SELECT * FROM atracao WHERE id = '".$ID."'");
  ...
  <div class="row discovery">
    ...
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="o_municipio_atracao_gravar.php" method="post" enctype="multipart/form-data">
          ...
          <div class=" col-sm-12 col-md-9">
            ...
            <div class=" col-sm-12 col-md-6">
              ...
              <div class="fancy-form fancy-form-select">
                ...
                <?php
                $sqlGlossario = mysql_query("SELECT * FROM atracao_categoria WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' ORDER BY Nome ASC");
                ...
                for ($y = 0; $y < $Glossario; $y++){
                    ...
                    ?>
            		<option value="<?php echo $verGlossario['id']; ?>" <?php if ($rsPagina['CdCategoria'] == $verGlossario['id']){?>selected<?php }?>><?php echo $verGlossario['Nome']; ?></option>
                <?php
                }
                ?>
            	</select>
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              ...
              <input id="endereco" name="endereco" class="form-control" type="text" placeholder="" values="<?php echo $rsPagina['Endereco'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              <label>Cidade</label>
              <input id="cidade" name="cidade" class="form-control" type="text" placeholder="" values="<?php echo $rsPagina['Cidade'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-4">
            <div class="fancy-form">
              <label>Bairro</label>
              <input id="bairro" name="bairro" class="form-control" type="text" placeholder="" values="<?php echo $rsPagina['Bairro'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-4">
            <div class="fancy-form">
              <label>CEP</label>
              <input id="CEP" name="CEP" class="form-control" type="text" placeholder="" values="<?php echo $rsPagina['Cep'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-4">
            <div class="fancy-form">
              ...
              <input id="telefone" name="telefone" class="form-control" type="text" placeholder="" values="<?php echo $rsPagina['Telefone'];?>">
            </div>
          </div>
