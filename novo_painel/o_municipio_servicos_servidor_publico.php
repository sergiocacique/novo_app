...
<div id="conteudo" class="container">
    <div class="row discovery">
        <div class="col-sm-9 col-md-10">
          <div class="header">
              <h1>Serviços ao Servidor Público</h1>
              <a class="btn btn-3d btn-reveal btn-red" href="o_municipio_servicos_servidor_publico_novo.php">ADICIONAR NOVO SERVIÇO AO SERVIDOR PÚBLICO</a>
          </div>
        </div>
    </div>
