...
<div id="conteudo" class="">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Adicionar Diário Oficial</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="publicacoes_oficiais_diario_oficial_adicionar.php" method="post" enctype="multipart/form-data">
        ...
        <div class=" col-sm-12 col-md-5">
          <div class="fancy-form">
            ...
            <input data-mask="date" id="dtAbertura" name="dtAbertura" class="form-control" type="text" >
          </div>
        </div>
