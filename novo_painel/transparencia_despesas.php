...
<div id="conteudo" class="container">
    ...
    <div class="row discovery2">
      ...
      <div class="table-responsive">
        ...
        $cmd = "select * from despesas WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' ORDER BY Ano DESC, Mes DESC";
        ...
        $cmd = "select * from despesas WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' ORDER BY Ano DESC, Mes DESC limit $inicio,$registros";
        $produtos = mysql_query($cmd);
        $total = mysql_num_rows($produtos);
        ...
        ?>
          ...
          <a href="transparencia_despesas_editar.php?despesa=<?php echo $produto['id'];?>">
