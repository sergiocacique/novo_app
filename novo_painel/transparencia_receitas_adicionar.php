...
$verAdmin = mysql_fetch_array($sqlAdmin);
    ...
    $DtAtualizacao = date('Y-m-d H:i:s');
        ...
        if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $dir . $nome_final)) {
            ...
            $query = "INSERT INTO receitas (CdPrefeitura,CdUsuario,Titulo,Mes,Ano,Arquivo,Acao,DtCadastro,Categoria) VALUES ('".$_SESSION['PrefeituraID']."','".$_SESSION['UsuarioID']."','" . $Titulo . "','" . $Mes . "','" . $Ano . "','" . $nome_final . "','" . $Acao . "','" . $DtAtualizacao . "','" . $Categoria . "')";
...
header('Location: transparencia_receitas.php'); exit;
?>
