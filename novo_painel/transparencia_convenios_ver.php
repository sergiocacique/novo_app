...
<div id="conteudo" class="container">
    <div class="row discovery">
        <div class="col-sm-9 col-md-10">
          <div class="header">
              <h1>Convênios de <strong><?php echo retorna_mes_extenso($Mes)?>/<?php echo $Ano?></strong></h1>
    ...
    <div class="row discovery2">
      ...
      <div class="table-responsive">
        ...
        $cmd = "select * from convenios WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' AND mes = '".$Mes."' AND ano = '".$Ano."'";
        ...
        $cmd = "select * from convenios WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' AND mes = '".$Mes."' AND ano = '".$Ano."' limit $inicio,$registros";
        $produtos = mysql_query($cmd);
        $total = mysql_num_rows($produtos);
        ...
        ?>
          ...
          <a href="transparencia_convenios_editar.php?convenio=<?php echo $produto['id'];?>">
          <h5 class="<?php echo $corFonte;?>"><?php echo $produto['orgao'];?></h5>
          <p>
              <strong>SIAFI:</strong> <?php echo $produto['nunSIAFI'];?> <br>
              <strong>Tipo:</strong> <?php echo $produto['Tipo'];?>
          </p>
        </a>
      </div>
        </div>
