...
$sqlPagina = mysql_query("SELECT * FROM diarias WHERE id = '".$id."'");
...
<div id="conteudo" class="container">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Alterar Diária</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form id="formulario_clientes" name="formulario_clientes" class="validate" action="transparencia_diaria_gravar.php" method="post">
      ...
      <div class=" col-sm-12 col-md-6">
        <div class="fancy-form">
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              <label>Cargo</label>
              <input id="Cargo" name="Cargo" class="form-control" value="<?php echo $rsPagina['cargo'];?>" type="text" placeholder="Digite o Destino Completo">
            </div>
          </div>
            ...
            <div class="fancy-form fancy-form-select">
              <select class="form-control" id="secretaria" name="secretaria">
                ...
                for ($y = 0; $y < $Glossario; $y++){
                    ...
                    ?>
            		<option value="<?php echo $verGlossario['NomeDepartamento']; ?>" <?php if ($verGlossario['NomeDepartamento'] == $rsPagina['secretaria']){?>selected<?php }?>><?php echo $verGlossario['NomeDepartamento']; ?></option>
                <?php
                }
                ?>
            	</select>
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              <label>Periodo</label>
              <input id="Periodo" name="Periodo" class="form-control" value="<?php echo $rsPagina['periodo'];?>" type="text" placeholder="Digite o Destino Completo">
            </div>
          </div>
          ...
          <div class="box-branco">
            ...
            <div class=" col-sm-12 col-md-2">
              <div class="fancy-form">
                <label>Dias</label>
                <input class="form-control" id="dias" name="dias" placeholder="Dias" value="<?php echo $rsPagina['dias'];?>">
              </div>
            </div>
...
<input type="tel" pattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$" value="<?php echo number_format($rsPagina['valor_diaria'], 2, ',', '.');?>" class="form-control" id="valor_diaria" name="valor_diaria" placeholder="0,00" onkeyup="maskIt(this,event,'###.###.###,##',true), soma1()">              </div>
            </div>

            <div class=" col-sm-12 col-md-5">
              <div class="fancy-form">
                <label>Valor Bruto (R$)</label>
                <input data-mask="money" class="form-control" id="valor_bruto" name="valor_bruto" placeholder="0,00" value="<?php echo number_format($rsPagina['valor_bruto'], 2, ',', '.');?>">
              </div>
            </div>
            ...
            <div class=" col-sm-12 col-md-4">
              <div class="fancy-form">
                ...
                <input type="tel" pattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$" class="form-control" id="inss" name="inss" placeholder="0,00" onkeyup="maskIt(this,event,'###.###.###,##',true), subtrai1()" value="<?php echo number_format($rsPagina['inss'], 2, ',', '.');?>">
              </div>
            </div>
            ...
            <div class=" col-sm-12 col-md-4">
              <div class="fancy-form">
                ...
                <input type="tel" pattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$" data-mask="money" class="form-control" id="irrf" name="irrf" placeholder="0,00" onkeyup="maskIt(this,event,'###.###.###,##',true), subtrai1()" value="<?php echo number_format($rsPagina['irff'], 2, ',', '.');?>">
              </div>
            </div>
            ...
            <div class=" col-sm-12 col-md-4">
              <div class="fancy-form">
                ...
                <input data-mask="money" class="form-control" id="valor_liquido" name="valor_liquido" placeholder="0,00" value="<?php echo number_format($rsPagina['valor_liquido'], 2, ',', '.');?>">
              </div>
            </div>
