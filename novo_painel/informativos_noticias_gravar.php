...
$verAdmin = mysql_fetch_array($sqlAdmin);
    ...
    if ($_FILES['arquivo']['name'] != "") {
        ...
        if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $dir . $nome_final)) {
            ...
            $query = "UPDATE site_noticias SET CdCategoria = '" . $CdCategoria . "',CdSecretaria = '" . $CdSecretaria . "',DtCadastro = '" . $DtCadastro . "',Titulo = '" . $Titulo . "',Materia = '" . $Materia . "',Imagem = '" . $nome_final . "',LegendaFoto = '" . $LegendaFoto . "', Acao = '" . $Acao . "', Fotografo = '" . $Fotografo . "' WHERE CdNoticia = '".$CdNoticia."'";
        ...
        $query = "UPDATE site_noticias SET CdCategoria = '" . $CdCategoria . "', CdSecretaria = '" . $CdSecretaria . "', DtCadastro = '" . $DtCadastro . "', Titulo = '" . $Titulo . "', Materia = '" . $Materia . "', Acao = '" . $Acao . "' WHERE CdNoticia = '".$CdNoticia."'";
        $verifica = mysql_query($query);
