  ...
  <div class="row discovery">
    ...
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="informativos_eventos_adicionar.php" method="post">

          <div class=" col-sm-12 col-md-3">
            <div class="fancy-form">
              <label>Data Início do Evento</label>
              <input  data-mask="date" id="dtInicio" name="dtInicio" class="form-control masked" type="text" placeholder="DD/MM/AAAA" data-placeholder="_" data-format="99/99/9999">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-3">
            <div class="fancy-form">
              ...
              <input  data-mask="date" id="dtFim" name="dtFim" class="form-control masked" type="text" placeholder="DD/MM/AAAA" data-placeholder="_" data-format="99/99/9999">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="titulo" name="titulo" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
