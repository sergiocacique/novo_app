...
<div id="conteudo" class="container">
    <div class="row discovery">
        <div class="col-sm-9 col-md-10">
          <div class="header">
              <h1>Atrações</h1>
              <a class="btn btn-3d btn-reveal btn-red" href="o_municipio_atracao_novo.php">ADICIONAR NOVA ATRAÇÃO</a>
          </div>
        </div>
    </div>
    ...
    <div class="row discovery2">
      ...
      <div class="table-responsive">
        ...
        ?>
          ...
          <a href="o_municipio_atracao_editar.php?atracao=<?php echo $produto['CdNoticia'];?>">
