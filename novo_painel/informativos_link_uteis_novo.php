...
<div id="conteudo" class="container">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Adicionar Novo Link Úteis</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="informativos_link_uteis_adicionar.php" method="post">

          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              <label>Titulo do Link</label>
              <input id="titulo" name="titulo" class="form-control" type="text" placeholder="Digite o titulo do Link">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="url" name="url" class="form-control" type="text" placeholder="http://www.link.com.br">
            </div>
          </div>
