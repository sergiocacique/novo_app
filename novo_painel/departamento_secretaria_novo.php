...
<div id="conteudo" class="">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Adicionar Nova Secretária</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="departamento_secretaria_adicionar.php" method="post">


          <div class=" col-sm-12 col-md-10">
            <div class="fancy-form">
              <label>Nome da Secretária</label>
              <input id="NomeDepartamento" name="NomeDepartamento" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
          ...
          <div class=" col-sm-4 col-md-4">
            <div class="fancy-form">
              <label>Cargo</label>
              <input id="Cargo" name="Cargo" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
          ...
          <div class=" col-sm-6 col-md-6">
            <div class="fancy-form">
              ...
              <input id="NomeSecretario" name="NomeSecretario" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="Telefones" name="Telefones" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="Endereco" name="Endereco" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              <label>E-mail</label>
              <input id="Email" name="Email" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="Horario" name="Horario" class="form-control" type="text" placeholder="Digite o titulo da Evento">
            </div>
          </div>
