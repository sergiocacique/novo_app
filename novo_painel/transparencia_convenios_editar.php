...
$sqlPagina = mysql_query("SELECT * FROM convenios WHERE id = '".$id."'");
  ...
  <div class="row discovery">
    ...
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="transparencia_convenios_gravar.php" method="post">
      ...
      <div class=" col-sm-12 col-md-3">
        ...
        <div class="fancy-form fancy-form-select">
          <select class="form-control" id="Tipo" name="Tipo">
                <option value="Concedente" <?php if ($rsPagina['Tipo'] == "Concedente"){?>selected<?php }?>>Concedente</option>
                <option value="Convenente" <?php if ($rsPagina['Tipo'] == "Convenente"){?>selected<?php }?>>Convenente</option>
          </select>
        <i class="fancy-arrow"></i>
      </div>
    </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="SIAFI" name="SIAFI" class="form-control" type="text" value="<?php echo $rsPagina['nunSIAFI'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              <label>Órgão</label>
              <input id="orgao" name="orgao" class="form-control" value="<?php echo $rsPagina['orgao'];?>" type="text" placeholder="Digite o Destino Completo">
            </div>
          </div>

          <div class=" col-sm-12 col-md-12">
            <label>Objeto do Convênio</label>
            <textarea name="objeto" class="form-control" rows="5" id="objeto"><?php echo $rsPagina['objeto'];?></textarea>
          </div>
          ...
          <div class="box-branco">
              ...
              <div class=" col-sm-12 col-md-4">
                ...
                <input id="val_liberado" name="val_liberado" class="form-control" value="<?php echo number_format($rsPagina['liberado'], 2, ',', '.');?>" type="text">
              </div>

              <div class=" col-sm-12 col-md-4">
                <label>Valor Contrapartida (R$)</label>
                <input id="val_contrapartida" name="val_contrapartida" class="form-control" value="<?php echo number_format($rsPagina['Contrapartida'], 2, ',', '.');?>" type="text">
              </div>
              ...
              <div class=" col-sm-12 col-md-4">
                ...
                <input id="data_publicacao" name="data_publicacao" class="form-control" value="<?php echo date('d/m/Y', strtotime($rsPagina['Publicacao']));?>" type="text">
              </div>
          </div>

          <div class=" col-sm-12 col-md-4">
            <label>Prorrogação</label>
            <input id="prorrogacao" name="prorrogacao" class="form-control" value="<?php echo $rsPagina['prorrogacao'];?>" type="text">
          </div>

          <div class=" col-sm-12 col-md-4">
            <label>Status do Convênio</label>
            <input id="status_convenio" name="status_convenio" class="form-control" value="<?php echo $rsPagina['estatus'];?>" type="text">
          </div>

          <div class=" col-sm-12 col-md-4">
            <label>Execução do Convênio</label>
            <input id="execucao" name="execucao" class="form-control" value="<?php echo number_format($rsPagina['execucao'], 2, ',', '.');?>" type="text">
          </div>

          <div class=" col-sm-12 col-md-12">
            <label>Observação do Convênio</label>
            <textarea name="observacao" class="form-control" rows="5" id="observacao"><?php echo $rsPagina['observacao'];?></textarea>
          </div>
