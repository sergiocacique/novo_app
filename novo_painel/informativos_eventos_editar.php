...
<?php
$CdNoticia = $_GET['evento'];

$sqlPagina = mysql_query("SELECT * FROM eventos WHERE id = '".$CdNoticia."'");
  ...
  <div class="row discovery">
    ...
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="informativos_eventos_gravar.php" method="post">
          <input type="hidden" id="id" name="id" value="<?php echo $rsPagina['id'];?>">

          <div class=" col-sm-12 col-md-3">
            <div class="fancy-form">
              <label>Data Início do Evento</label>
              <input id="DtInicio" name="DtInicio" class="form-control masked" type="text" placeholder="<?php echo date('d/m/Y', strtotime($rsPagina['DtInicio']));?>" data-placeholder="_" data-format="99/99/9999" value="<?php echo date('d/m/Y', strtotime($rsPagina['DtInicio']));?>">
            </div>
          </div>
          <?php
          if($rsPagina['DtFim'] == "0000-00-00" OR $rsPagina['DtFim'] == ""){
            $DtFim = "";
          }else{
            $DtFim = date('d/m/Y', strtotime($rsPagina['DtFim']));
          }
           ?>
          <div class=" col-sm-12 col-md-3">
            <div class="fancy-form">
              <label>Data Fim do Evento</label>
              <input id="DtFim" name="dtcadastro" class="form-control masked" type="text" placeholder="<?php echo $DtFim;?>" data-placeholder="_" data-format="99/99/9999" value="<?php echo $DtFim;?>">
            </div>
          </div>
