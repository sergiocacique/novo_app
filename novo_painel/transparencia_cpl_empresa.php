  ...
  <div class="row discovery">
    ...
    <div class="row discovery2">
      <ul class="nav nav-tabs">
      	...
      	<li class="active"><a href="javascript:void(0)">Empresa</a></li>
      ...
      <div class="table-responsive">
        <form id="formulario_clientes" name="formulario_clientes" class="validate" action="transparencia_cpl_empresa_adicionar.php" method="post">
        <input type="hidden" name="CdCPL" value="<?php echo $rsPagina['CdCPL'];?>">

        <div class=" col-sm-12 col-md-5">
          <div class="fancy-form">
            <label>Nome da Empresa</label>
            <input id="empresa" name="empresa" class="form-control" type="text" placeholder="Nome completo da Empresa">
          </div>
        </div>
        ...
        <div class=" col-sm-12 col-md-3">
          <div class="fancy-form">
            ...
            <input id="cnpjcpf" name="cnpjcpf" class="form-control" type="text" placeholder="00.000.000/0000-00">
          </div>
        </div>
          ...
          <table class="table table-bordered table-striped">
            <colgroup>
              ...
              <col class="col-xs-7">
        		...
        		<tbody>
              <?php
              $sqlGlossario = mysql_query("SELECT * FROM cpl_empresa WHERE CdCPL = '".$rsPagina['CdCPL']."' AND CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' ORDER BY Nome ASC");
              ...
              for ($y = 0; $y < $Glossario; $y++){
                  ...
                  ?>
        			<tr>
        				<td><a class="btn btn-3d btn-reveal btn-red" href="transparencia_cpl_empresa_excluir.php?id=<?php echo $verGlossario['id']; ?>&CdCPL=<?php echo $verGlossario['CdCPL']; ?>">EXCLUIR</a></td>
              <td><?php echo $verGlossario['Situacao']; ?></td>
                <td><?php echo $verGlossario['CPFCNPJ']; ?></td>
