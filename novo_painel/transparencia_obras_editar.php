...
$sqlPagina = mysql_query("SELECT * FROM obras WHERE id = '".$id."'");
  ...
  <div class="row discovery">
    ...
    <div class="row discovery2">
      <div class="table-responsive">
        <form id="formulario_clientes" name="formulario_clientes" class="validate" action="transparencia_obra_gravar.php" method="post">
        ...
        <div class=" col-sm-12 col-md-3">
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              ...
              <input id="numero_processo" name="numero_processo" class="form-control" type="text" value="<?php echo $rsPagina['numero_processo'];?>" placeholder="Digite o Nome Completo">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-12">
            ...
            <textarea name="observacao" class="form-control" rows="5" id="objeto"><?php echo $rsPagina['observacao'];?></textarea>
          </div>

          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              <label>Status da Obra</label>
              <input id="estatus" name="estatus" class="form-control" value="<?php echo $rsPagina['estatus'];?>" type="text" placeholder="Digite o Destino Completo">
            </div>
          </div>
          ...
          <div class="box-branco">
            ...
            <div class=" col-sm-12 col-md-4">
              <div class="fancy-form">
                ...
                <input data-mask="money" id="convenio" name="convenio" class="form-control" value="<?php echo $rsPagina['convenio'];?>" type="text" placeholder="Digite o Destino Completo">
              </div>
            </div>
            ...
            <div class=" col-sm-12 col-md-4">
              <div class="fancy-form">
                ...
                <input data-mask="money" id="recurso_proprio" name="recurso_proprio" class="form-control" value="<?php echo $rsPagina['recurso_proprio'];?>" type="text" placeholder="Digite o Destino Completo">
              </div>
            </div>
            ...
            <div class=" col-sm-12 col-md-4">
              <div class="fancy-form">
                ...
                <input data-mask="money" id="fisico" name="fisico" class="form-control" value="<?php echo $rsPagina['fisico'];?>" type="text" placeholder="Digite o Destino Completo">
              </div>
            </div>
            ...
            <div class=" col-sm-12 col-md-6">
              <div class="fancy-form">
                ...
                <input data-mask="money" id="valor_realizado" name="valor_realizado" class="form-control" value="<?php echo $rsPagina['valor_realizado'];?>" type="text" placeholder="Digite o Destino Completo">
              </div>
            </div>
            ...
            <div class=" col-sm-12 col-md-6">
              <div class="fancy-form">
                ...
                <input data-mask="money" id="total" name="total" class="form-control" value="<?php echo $rsPagina['total'];?>" type="text" placeholder="Digite o Destino Completo">
              </div>
            </div>
