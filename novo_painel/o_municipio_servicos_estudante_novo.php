...
<div id="conteudo" class="container">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Adicionar Novo Serviços ao Estudante</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="o_municipio_servicos_estudante_adicionar.php" method="post" enctype="multipart/form-data">
