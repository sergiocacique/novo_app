...
<div id="conteudo" class="container">
    ...
    <div class="row discovery2">
      ...
      <div class="table-responsive">
        ...
        $cmd = "select * from diarias WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' AND mes = '".$Mes."' AND ano = '".$Ano."'";
        ...
        $cmd = "select * from diarias WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' AND mes = '".$Mes."' AND ano = '".$Ano."' limit $inicio,$registros";
        $produtos = mysql_query($cmd);
        $total = mysql_num_rows($produtos);
        ...
        ?>
          ...
          <a href="transparencia_diaria_editar.php?passagem=<?php echo $produto['id'];?>">
          <h5 class="<?php echo $corFonte;?>"><?php echo $produto['nome'];?></h5>
          <p>
              <strong>Destino:</strong> <?php echo $produto['destino'];?> <br>
              <strong>Cargo:</strong> <?php echo $produto['cargo'];?>
          </p>
        </a>
      </div>
        </div>
