...
$verAdmin = mysql_fetch_array($sqlAdmin);
    ...
    $DtAntiga = $_POST['dtcadastro'];
    $DtCadastro = implode("-",array_reverse(explode("/",$DtAntiga)));
    ...
    $LegendaFoto = addslashes($_POST['LegendaFoto']);
    ...
    if ($_FILES['arquivo']['name'] != "") {
        ...
        $dir = '../arquivosDinamicos/municipio/'.$verAdmin['Pasta'].'/noticias/';
        ...
        if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $dir . $nome_final)) {
            ...
            $query = "INSERT INTO site_noticias (CdPrefeitura,CdCategoria,CdSecretaria,DtCadastro,Titulo,Materia,Imagem,LegendaFoto,Acao,Cliques,Fotografo) VALUES ('".$_SESSION['PrefeituraID']."','" . $CdCategoria . "','" . $CdSecretaria . "','" . $DtCadastro . "','" . $Titulo . "','" . $Materia . "','" . $nome_final . "','" . $LegendaFoto . "','" . $Acao . "','" . $Cliques . "','" . $Fotografo . "')";
        ...
        $query = "INSERT INTO site_noticias (CdPrefeitura,CdCategoria,CdSecretaria,DtCadastro,Titulo,Materia,Acao,Cliques) VALUES ('".$_SESSION['PrefeituraID']."','" . $CdCategoria . "','" . $CdSecretaria . "','" . $DtCadastro . "','" . $Titulo . "','" . $Materia . "','" . $Acao . "','" . $Cliques . "')";
        $verifica = mysql_query($query);
