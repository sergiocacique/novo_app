...
$sqlPagina = mysql_query("SELECT * FROM publicacoes_oficiais WHERE id = '".$Cod."'");
$rsPagina = mysql_fetch_array($sqlPagina);

$sqlCat = mysql_query("SELECT * FROM publicacoes_oficiais_categoria WHERE CdCategoria = '".$rsPagina['CdCategoria']."'");
...
<div id="conteudo" class="">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Alterar <?php echo $rsCat['Nome'];?></h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="publicacoes_oficiais_licitacao_gravar.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $rsPagina['id'];?>">
        <input type="hidden" name="Categoria" value="<?php echo $rsPagina['CdCategoria'];?>">


          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              <label>Titulo</label>
              <input id="titulo" name="titulo" class="form-control" type="text" value="<?php echo $rsPagina['Titulo'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-5">
            ...
            <div class="fancy-form fancy-form-select">
              <select class="form-control" id="Subcategoria" name="Subcategoria">
                <?php
                $sqlGlossario = mysql_query("SELECT * FROM publicacoes_oficiais_sub WHERE CdCategoria = ".$rsPagina['CdCategoria']." ORDER BY Nome2 ASC");
                ...
                for ($y = 0; $y < $Glossario; $y++){
                    ...
                    ?>
                <option value="<?php echo $verGlossario['CdSub']; ?>" <?php if ($rsPagina['CdSubCategoria'] == $verGlossario['CdSub']){?>selected<?php }?>><?php echo $verGlossario['Nome2']; ?></option>
                <?php
                }
                ?>
              </select>
        ...
        <div class=" col-sm-12 col-md-11">
          <div class="fancy-form">
            ...
            <input id="Descricao" name="Descricao" class="form-control" type="text" value="<?php echo $rsPagina['Descricao'];?>">
          </div>
        </div>
        ...
        <div class=" col-sm-12 col-md-7">
          <div class="fancy-form">
            ...
            <input data-mask="date" id="dtAbertura" name="dtAbertura" class="form-control" type="text" value="<?php echo date('d/m/Y', strtotime($rsPagina['DtAbertura']));?>">
          </div>
        </div>
