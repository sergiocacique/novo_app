...
<?php
$CdNoticia = $_GET['departamento'];

$sqlPagina = mysql_query("SELECT * FROM departamento WHERE CdDepartamento = '".$CdNoticia."'");
...
<div id="conteudo" class="">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Alterar Secretária</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="departamento_secretaria_gravar.php" method="post">
          <input type="hidden" name="CdDepartamento" value="<?php echo $rsPagina['CdDepartamento'];?>">


          <div class=" col-sm-12 col-md-10">
            <div class="fancy-form">
              <label>Nome da Secretária</label>
              <input id="NomeDepartamento" name="NomeDepartamento" class="form-control" type="text" value="<?php echo $rsPagina['NomeDepartamento'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-4 col-md-4">
            <div class="fancy-form">
              <label>Cargo</label>
              <input id="Cargo" name="Cargo" class="form-control" type="text" value="<?php echo $rsPagina['Cargo'];?>">
            </div>
          </div>

          <div class=" col-sm-6 col-md-6">
            <div class="fancy-form">
              <label>Nome Secretário</label>
              <input id="NomeSecretario" name="NomeSecretario" class="form-control" type="text" value="<?php echo $rsPagina['NomeSecretario'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-5">
            ...
            <div class="fancy-form fancy-form-select">
              <select class="form-control" id="Tipo" name="Tipo">
                <option value="Secretaria" <?php if ($rsPagina['Tipo'] == "Secretaria"){?>selected<?php }?>>Secretaria</option>
                <option value="Órgãos" <?php if ($rsPagina['Tipo'] == "Órgãos"){?>selected<?php }?>>Órgãos</option>
              </select>
          ...
          <div class=" col-sm-10 col-md-10">
            <label>Sobre a secretária</label>
            <textarea name="editor1" id="editor1"><?php echo $rsPagina['Sobre'];?></textarea>
              <script>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="Telefones" name="Telefones" class="form-control" type="text" value="<?php echo $rsPagina['Telefones'];?>">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-7">
            <div class="fancy-form">
              ...
              <input id="Horario" name="Horario" class="form-control" type="text" value="<?php echo $rsPagina['Horario'];?>">
            </div>
          </div>
