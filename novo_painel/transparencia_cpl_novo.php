    ...
    <div class="row discovery2">
      <div class="table-responsive">
        ...
        <div class=" col-sm-12 col-md-3">
          <div class="fancy-form">
            ...
            <input id="Periodo" name="Periodo" class="form-control" type="text" placeholder="0001/2016">
          </div>
        </div>
        ...
        <div class=" col-sm-12 col-md-3">
          <div class="fancy-form">
            ...
            <input id="Periodo" name="Periodo" class="form-control" type="text" placeholder="0,00">
          </div>
        </div>
      ...
      <div class=" col-sm-12 col-md-6">
        <div class="fancy-form">
          ...
          <input id="Periodo" name="Periodo" class="form-control" type="text" placeholder="00/00/0000">
        </div>
      </div>
      ...
      <div class=" col-sm-12 col-md-6">
        <div class="fancy-form">
          ...
          <input id="Periodo" name="Periodo" class="form-control" type="text" placeholder="DOM - Diário Oficial Municipal">
        </div>
      </div>
      ...
      <div class=" col-sm-12 col-md-6">
        <div class="fancy-form">
          ...
          <input id="Periodo" name="Periodo" class="form-control" type="text" placeholder="DOM - 0001">
        </div>
      </div>
</div>
