...
<div id="conteudo" class="container">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Alterar Dados do Municipio</h1>
        </div>
      </div>
  </div>
    ...
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="o_municipio_dados_gravar.php" method="post">

          <div class=" col-sm-12 col-md-12">
            <textarea name="editor1" id="editor1"><?php echo $rsPagina['Dados'];?></textarea>
              <script>
