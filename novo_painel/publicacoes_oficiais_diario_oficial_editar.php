...
$sqlPagina = mysql_query("SELECT * FROM diario_oficial WHERE id = '".$Cod."'");
...
<div id="conteudo" class="">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Alterar Diário Oficial</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="publicacoes_oficiais_diario_oficial_gravar.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $rsPagina['id'];?>">
          ...
          <div class=" col-sm-12 col-md-5">
            <div class="fancy-form">
              ...
              <input id="titulo" name="titulo" class="form-control" type="text" value="<?php echo $rsPagina['NumDiario'];?>">
            </div>
          </div>
        ...
        <div class=" col-sm-12 col-md-5">
          <div class="fancy-form">
            ...
            <input data-mask="date" id="dtAbertura" name="dtAbertura" class="form-control" type="text" value="<?php echo date('d/m/Y', strtotime($rsPagina['DtCadastro']));?>">
          </div>
        </div>
