...
<div id="conteudo" class="container">
    ...
    <div class="row discovery2">
      ...
      <div class="table-responsive">
        ...
        $cmd = "select * from vw_servicos WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Tipo = 'estudante' AND Acao <> 'Excluido' ORDER BY Titulo DESC";
        ...
        $cmd = "select * from vw_servicos WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Tipo = 'estudante' AND Acao <> 'Excluido' ORDER BY Titulo DESC limit $inicio,$registros";
        $produtos = mysql_query($cmd);
        $total = mysql_num_rows($produtos);
