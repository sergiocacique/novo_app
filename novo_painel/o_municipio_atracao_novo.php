...
<div id="conteudo" class="container">
  <div class="row discovery">
      <div class="col-sm-9 col-md-10">
        <div class="header">
            <h1>Adicionar Nova Atração</h1>
        </div>
      </div>
  </div>
    <div class="row discovery2">
      <div class="table-responsive">
        <form class="validate" action="o_municipio_atracao_adicionar.php" method="post" enctype="multipart/form-data">
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              ...
              <input id="endereco" name="endereco" class="form-control" type="text" placeholder="">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="fancy-form">
              <label>Cidade</label>
              <input id="cidade" name="cidade" class="form-control" type="text" placeholder="">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-4">
            <div class="fancy-form">
              <label>Bairro</label>
              <input id="bairro" name="bairro" class="form-control" type="text" placeholder="">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-4">
            <div class="fancy-form">
              <label>CEP</label>
              <input id="CEP" name="CEP" class="form-control" type="text" placeholder="">
            </div>
          </div>
          ...
          <div class=" col-sm-12 col-md-4">
            <div class="fancy-form">
              ...
              <input id="telefone" name="telefone" class="form-control" type="text" placeholder="">
            </div>
          </div>
