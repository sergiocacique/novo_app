...
<div id="conteudo" class="container">
    <div class="row discovery">
        <div class="col-sm-9 col-md-10">
          <div class="header">
              ...
              <a class="btn btn-3d btn-reveal btn-red" href="o_municipio_servicos_cidadao_novo.php">ADICIONAR NOVO SERVIÇO AO CIDADÃO</a>
          </div>
        </div>
    </div>
    ...
    <div class="row discovery2">
      ...
      <div class="table-responsive">
        ...
        $cmd = "select * from vw_servicos WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Tipo = 'cidadao' AND Acao <> 'Excluido' ORDER BY Titulo DESC";
        ...
        $cmd = "select * from vw_servicos WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Tipo = 'cidadao' AND Acao <> 'Excluido' ORDER BY Titulo DESC limit $inicio,$registros";
        $produtos = mysql_query($cmd);
        $total = mysql_num_rows($produtos);
        ...
        ?>
          ...
          <a href="o_municipio_servicos_cidadao_editar.php?servico=<?php echo $produto['id'];?>">
