...
<div id="conteudo" class="container">
    <div class="row discovery">
        <div class="col-sm-9 col-md-10">
          <div class="header">
              <h1>Folha de Pagamento de <strong><?php echo retorna_mes_extenso($Mes)?>/<?php echo $Ano?></strong></h1>
    ...
    <div class="row discovery2">
      ...
      <div class="table-responsive">
        ...
        $cmd = "select * from servidor WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' AND Mes = '".$Mes."' AND Ano = '".$Ano."' GROUP BY Protocolo";
        ...
        $cmd = "select * from servidor WHERE CdPrefeitura = '".$_SESSION['PrefeituraID']."' AND Acao <> 'Excluido' AND Mes = '".$Mes."' AND Ano = '".$Ano."' GROUP BY Protocolo limit $inicio,$registros";
        $produtos = mysql_query($cmd);
        $total = mysql_num_rows($produtos);
